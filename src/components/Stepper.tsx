...
type StepperProps = {
  ...
  // Gate advancing past the current step (e.g. field validation). Returning
  // false keeps the stepper on the current step.
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "var(--stepper-inactive)", color: "var(--stepper-inactive-fg)" },
          active: { scale: 1, backgroundColor: "var(--stepper-accent)", color: "#fff" },
          complete: { scale: 1, backgroundColor: "var(--stepper-accent)", color: "#fff" },
        }}
...
function StepConnector({ isComplete }: { isComplete: boolean }) {
  const lineVariants = {
    ...
    complete: { width: "100%", backgroundColor: "var(--stepper-accent)" },
  };
