...
export default function Footer() {
  return (
    <footer className="bg-dark px-5 py-10 text-center text-sm text-cream/70">
      <p className="flex flex-wrap items-center justify-center gap-4">
        ...
        <a
          ...
          className="flex items-center gap-1.5 rounded-full bg-accent/20 px-3 py-1.5 font-medium text-cream transition hover:bg-accent/30"
        >
